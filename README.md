    ...
    <div class="grid">
        ...
        <div class="card">
            ...
            <div class="card-content">
                ...
                <a href="https://mileniumtvi.com/los-presidentes-daniel-noboa-y-javier-milei-coinciden-en-combatir-la-inseguridad-y-la-corrupcion-durante-reunion-bilateral" target="_blank">Leer más</a>
            </div>
        </div>
        <div class="card">
            <img src="https://via.placeholder.com/250x150" alt="La cooperación en seguridad y la integración comercial son los resultados de la gira oficial del presidente Noboa a Brasil, Uruguay y Argentina">
            <div class="card-content">
                ...
                <a href="https://mileniumtvi.com/la-cooperacion-en-seguridad-y-la-integracion-comercial-son-los-resultados-de-la-gira-oficial-del-presidente-noboa-a-brasil-uruguay-y-argentina" target="_blank">Leer más</a>
            </div>
        </div>
        <div class="card">
            <img src="https://via.placeholder.com/250x150" alt="El sector empresarial japonés y el presidente Noboa coinciden en la necesidad de acelerar la firma de un acuerdo comercial">
            <div class="card-content">
                ...
                <a href="https://mileniumtvi.com/el-sector-empresarial-japones-y-el-presidente-noboa-coinciden-en-la-necesidad-de-acelerar-la-firma-de-un-acuerdo-comercial" target="_blank">Leer más</a>
            </div>
        </div>
        <div class="card">
