...
<section id="news" class="section">
    ...
    <div class="grid">
        ...
        <div class="card">
            <img src="https://mileniumtvi.com/wp-content/uploads/2025/07/Bloque-de-seguridad-Duran.jpg" alt="Punto Digital Gratuito">
            <div class="card-content">
                <h3>Ibarra cuenta con un nuevo Punto Digital Gratuito</h3>
                <p>Ibarra cuenta con un nuevo Punto Digital Gratuito para impulsar la inclusión digital y el desarrollo local.</p>
                <a href="https://mileniumtvi.com/ibarra-cuenta-con-un-nuevo-punto-digital-gratuito-" target="_blank">Leer más</a>
            </div>
        </div>
